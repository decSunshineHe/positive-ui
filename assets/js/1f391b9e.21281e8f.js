...
(self.webpackChunkui_website = self.webpackChunkui_website || []).push([
  [85],
  {
    450: (e, n, t) => {
      ...
      function c(e) {
        let { children: n } = e;
        return a.createElement(l.Zo, { components: r.Z }, n);
      }
    },
    5432: (e, n, t) => {
      ...
      var a = t(7378),
        ...
        o = t(450),
        s = t(7061);
      const m = { mdxPageWrapper: 'mdxPageWrapper_sagS' };
      function d(e) {
        const { content: n } = e,
          {
        ...
        return a.createElement(
          r.FG,
          { className: (0, l.default)(f ?? c.k.wrapper.mdxPages, c.k.page.mdxPage) },
          ...
          a.createElement(
            ...
            a.createElement(
              ...
              a.createElement(
                'div',
                { className: (0, l.default)('row', m.mdxPageWrapper) },
                a.createElement(
                  'div',
                  { className: (0, l.default)('col', !v && 'col--8') },
                  a.createElement('article', null, a.createElement(o.Z, null, a.createElement(n, null)))
                ),
                !v &&
                  n.toc.length > 0 &&
                  a.createElement(
    ...
    7061: (e, n, t) => {
      ...
      var a = t(5773),
        ...
        r = t(8944),
        c = t(6033);
      const i = { tableOfContents: 'tableOfContents_XG6w', docItemContainer: 'docItemContainer_Tr6w' },
      ...
      function m(e) {
        ...
        return l.createElement(
          'div',
          { className: (0, r.default)(i.tableOfContents, 'thin-scrollbar', n) },
          l.createElement(c.Z, (0, a.Z)({}, t, { linkClassName: o, linkActiveClassName: s }))
        );
      }
    },
    6033: (e, n, t) => {
      ...
      function i(e) {
        ...
        return n.flatMap(e => {
          const n = i({ toc: e.children, minHeadingLevel: t, maxHeadingLevel: a });
          return (function (e) {
      ...
      function d(e) {
        ...
        (0, l.useEffect)(() => {
          if (!e) return () => {};
          const { linkClassName: a, linkActiveClassName: l, minHeadingLevel: r, maxHeadingLevel: c } = e;
          function i() {
            const e = (function (e) {
            ...
            e.forEach(e => {
              !(function (e, t) {
                t
                  ? (n.current && n.current !== e && n.current.classList.remove(l), e.classList.add(l), (n.current = e))
          ...
          ? l.createElement(
              ...
              n.map(e =>
                l.createElement(
                  ...
                  l.createElement(u, { isChild: !0, toc: e.children, className: t, linkClassName: a })
                )
              )
            )
          : null;
      ...
      function v(e) {
        ...
        const g = (0, r.L)(),
          ...
          p = (function (e) {
            let { toc: n, minHeadingLevel: t, maxHeadingLevel: a } = e;
            return (0, l.useMemo)(() => i({ toc: c(n), minHeadingLevel: t, maxHeadingLevel: a }), [n, t, a]);
          })({ toc: n, minHeadingLevel: h, maxHeadingLevel: L });
        return (
          d(
            (0, l.useMemo)(() => {
              if (o && s) return { linkClassName: o, linkActiveClassName: s, minHeadingLevel: h, maxHeadingLevel: L };
            }, [o, s, h, L])
          ),
          l.createElement(f, (0, a.Z)({ toc: p, className: t, linkClassName: o }, v))
        );
      }
    },
  },
