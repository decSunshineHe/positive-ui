    ...
    return (React.createElement(ConfigProvider, { theme: { algorithm: theme.darkAlgorithm } },
        React.createElement(Space, { align: "center" },
            ...
            React.createElement(Dropdown, { overlayClassName: styles.overlay, autoFocus: true, autoAdjustOverflow: false, placement: "bottomRight", destroyPopupOnHide: true, arrow: true, menu: {
                ...
                React.createElement("span", { className: styles.switchTenant }, "\u5207\u6362")))));
};

const MessageCenter = () => {
    return (React.createElement("div", null,
        React.createElement("h1", null, "SwitchStaff")));
};

export { MessageCenter, SwitchStaff };
